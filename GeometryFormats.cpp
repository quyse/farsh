...
GeometryFormats::GeometryFormats() :
	...
	aleSkinnedBoneNumbers(alSkinned->AddElement(alsSkinned, vlSkinned->AddElement(DataTypes::_uvec4, 32))),
	aleSkinnedBoneWeights(alSkinned->AddElement(alsSkinned, vlSkinned->AddElement(DataTypes::_vec4, 48)))
{}
